...
trait SchemaUtils
{
   ...
   */
  public static function foreignTo(
    Blueprint &$table,
    $asField = null,
    $idField = 'id',
    $deleteType = 'restrict'
  ...
  {
    return addslashes(strstr(preg_replace('/\s+/', ' ', $comment), ', ej:',
      true));
  }
   ...
   * @return void
   */
  protected static function setTableComment(
    $tableName,
    $comment,
    $connection = null
  ) {
